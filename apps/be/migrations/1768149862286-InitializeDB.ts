...
export class InitializeDB1768149862286 implements MigrationInterface {
    name = 'InitializeDB1768149862286'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."swap_requests_type_enum" AS ENUM('CLEANING', 'OPENTALK')`);
        await queryRunner.query(`CREATE TABLE "swap_requests" ("created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "created_by" integer, "updated_by" integer, "id" SERIAL NOT NULL, "from_event_id" integer NOT NULL, "to_event_id" integer NOT NULL, "requester_id" integer, "target_staff_id" integer, "reason" character varying NOT NULL, "status" "public"."swap_requests_status_enum" NOT NULL DEFAULT 'PENDING', "type" "public"."swap_requests_type_enum" NOT NULL, "review_note" character varying, CONSTRAINT "PK_4a3a8b292e0e8df37acbc47e648" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."opentalk_slides_type_enum" AS ENUM('file', 'link')`);
        await queryRunner.query(`CREATE TYPE "public"."opentalk_slides_status_enum" AS ENUM('PENDING', 'APPROVED', 'REJECTED')`);
        await queryRunner.query(`CREATE TABLE "opentalk_slides" ("created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "created_by" integer, "updated_by" integer, "id" SERIAL NOT NULL, "event_id" integer NOT NULL, "topic" character varying, "slide_url" character varying, "slide_key" character varying, "type" "public"."opentalk_slides_type_enum" NOT NULL, "status" "public"."opentalk_slides_status_enum" NOT NULL DEFAULT 'PENDING', "rejection_reason" character varying, "approved_by" integer, "approved_at" TIMESTAMP, "rejected_by" integer, "rejected_at" TIMESTAMP, CONSTRAINT "PK_b08537aa74942400dd264aac298" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."opentalk_slides_type_enum"`);
