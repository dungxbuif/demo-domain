...
export function FilePreviewDialog({
  ...
  console.log('[FilePreviewDialog] Rendered with:', { open, url, fileName, fileType });
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="h-[90vh] !max-w-6xl !w-6xl flex flex-col p-0 gap-0" aria-describedby={undefined}>
