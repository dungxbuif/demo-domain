...
2. **Xử lý Remote & Inactive**:
   -  **Remote**:
      -  Lịch remote do user tự submit và quản lý.
      -  Cần submit **trước 1 ngày**.
      -  Nếu submit trong ngày thực hiện: Không xếp lại lịch, ghi nhận vào **chức năng phạt**.
      -  Nếu 2 người cùng lịch dọn đều remote: **Tự tráo đổi** với người khác.
      -  **Workflow khi remote đột xuất**:
         1. Request trước 1 ngày.
         2. Role liên quan (HR/GDVP) review & approve.
         3. Nếu approve: Auto swap với người tiếp theo hoặc người được chỉ định cụ thể.
   -  **Inactive**: Tự động kiểm tra và điều chỉnh lịch.
   -  **Ngày nghỉ lễ**: Tự động skip.
      ˜
...
-  Cảnh báo nếu nhân viên có lịch remote
...
- remote_schedule (JSON hoặc bảng riêng)
- created_at
- updated_at
```
...
2. **Hàng ngày - Đầu ngày (8:00)**:
   ...
   -  Cảnh báo nếu người có lịch đang remote
